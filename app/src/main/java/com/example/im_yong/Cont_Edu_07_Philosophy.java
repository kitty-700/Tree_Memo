...
public class Cont_Edu_07_Philosophy {
    static void put_phi() {
        ...
        _fb(sc, "핵심");
        {
            ...
            _ip("피터스]_ 교육개념의 준거", true, 8);//1509p
            {
                _s();
        ...
        _fb(sc, "교육사조");
        {
            ...
            {
                _s();
                _ip("실용주의", "지식의 사회적 유용성이 있어야 가치로운 것");
                _ip("듀이]_ 교육론", "지식의 사회적 유용성이 있어야 가치로운 것");
                {
                    _s();
                    _ip("반성적 사고");
                    _ip("성장의 조건");
            ...
            {
                _s();
                _ip("진보주의", "feat.자연주의·실용주의\n아동의 성장을 통한 사회진보 추구");
                _ip("본질주의", "agnst.진보주의\n학문적 전통과 문화유산의 전달");
                _ip("항존주의", "진리·이성은 불변하므로, 고전을 통해 이성을 도야");
                _ip("재건주의", "교육을 통한 인류문화의 재건");
                _e();
            }
            _ip("현대의 교육철학");//1549p
            {
                _s();
                _ip("실증주의", "객관적 증거를 통한 입증\n자연과학적 방법론");
                ...
                _e();
                _ip("현상학", "현상이란 우리의 인식과 무관히 존재하는 오브젝트가 아니라 인간의 의식작용에 의해 구성되어 나타나게 된 것");
                {
                    _s();
                    _ip("하이데거]_ 현상학");
                }
                _ip("실존주의", "\"실존이 본질에 앞선다\"\n사전에 규정된 인간의 본질이란 없으며, 자유의지를 가진 인간이 스스로 선택하고 책임지며 자아실현");
                {
                    _s();
                    _ip("전인교육");
                    _ip("비연속적 성장");
