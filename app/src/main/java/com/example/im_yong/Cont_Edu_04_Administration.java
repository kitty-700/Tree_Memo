...
public class Cont_Edu_04_Administration {
    static void content_installing(int sc) {//subject code
        ...
        _fb(sc, "지도성론");
        {
            ...
            _ip("상황적 지도성론", "지도성의 효과는 상황에 따라 케바케이며, 상황을 무엇으로 보느냐에 따라 여러 이론 존재");
            {
                _s();
            ...
            _ip("새로운 지도성 이론");
            {
                ...
                _ip("변혁적 지도성론", true, "지도자는 높은 수준의 도덕성을 통해 카리스마를 보여 구성원의 존경을 이끌어냄");
                {
                    _s();
                    _ip("메커니즘", "지도자 : L\n구성원 : M\n리더십이란? L과 M의 상호작용");
                    {
                ...
                _ip("켈&지미어]_ 리더십 대용 상황모형", true, "대용상황 & 억제상황 제시를 통해 지도자의 행동이 상황에 따라 케바케임을 보임");
                {
                    _s();
        ...
        _fb(sc, "조직론");
        {
            ...
            _ip("조직 유형");
            {
                ...
                _ip("카츠&칸]_ 사회적 기능에 따른 분류", true, 6, "생산적·경제적 조직\n유지조직\n적응조직\n관리적·정치적 조직");
                _e();
            }
