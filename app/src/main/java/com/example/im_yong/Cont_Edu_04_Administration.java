...
public class Cont_Edu_04_Administration {
    static void put_adm() {
        ...
        _fb(sc, "동기이론");
        {
            ...
            {
                _s();
                _ip("매슬로우]_ 욕구계층이론", true);
                _ip("허즈버그]_ 동기-위생이론", true);
                _ip("동기 유발을 위한 직무 재설계", true);
                _ip("알더퍼]_ 생존-관계-성장 이론 (ERG)", true);
                _e();
            }
            _ip("└ 과정이론", "'어떻게' 동기가 유발되는가?");
            {
                _s();
                _ip("브룸]_ 기대이론", true);
                _ip("포터&롤러]_ 기대이론", true, "aka.성과-만족 이론");
                _ip("아담스]_ 공정성 이론", true);
                _ip("로크]_ 목표설정 이론", true);
                _e();
            }
            _e();
        }
